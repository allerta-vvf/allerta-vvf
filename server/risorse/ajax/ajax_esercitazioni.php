...
$risultato = $database->esegui("SELECT * FROM `%PREFIX%_esercitazioni` ORDER BY data DESC, inizio desc", true); // Pesco i dati della tabella e li ordino in base alla data
?>

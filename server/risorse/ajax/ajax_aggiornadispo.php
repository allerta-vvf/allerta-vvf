...
if(isset($_POST["nomeutenteattivato"]) && isset($_POST["nomeutenteattivatore"]) && $_POST["dispo"] == 1)	{
     $risultato = $database->esegui("UPDATE `%PREFIX%_vigili` SET disponibile = 1 WHERE nome = :nome", false, [":nome" => $_POST["nomeutenteattivato"]]);
     ...
     $risultato = $database->esegui("UPDATE `%PREFIX%_vigili` SET disponibile = 0 WHERE nome = :nome", false, [":nome" => $_POST["nomeutenteattivato"]]);
